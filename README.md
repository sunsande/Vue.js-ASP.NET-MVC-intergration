...
Not that if you want to debug the application in the browser using the Vue.js developer tools you won't be able to do so, because we builded the components in production mode.
